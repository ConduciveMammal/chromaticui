let spawn,https,fetch,path,CHROMATIC_POLL_INTERVAL,CHROMATIC_TIMEOUT;_af6‍.x([["checkResponse",()=>checkResponse],["default",()=>startApp]]);_af6‍.w("cross-spawn",[["spawn",["spawn"],function(v){spawn=v}]]);_af6‍.w("https",[["default",["https"],function(v){https=v}]]);_af6‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);_af6‍.w("path",[["default",["path"],function(v){path=v}]]);_af6‍.w("../constants",[["CHROMATIC_POLL_INTERVAL",["CHROMATIC_POLL_INTERVAL"],function(v){CHROMATIC_POLL_INTERVAL=v}],["CHROMATIC_TIMEOUT",["CHROMATIC_TIMEOUT"],function(v){CHROMATIC_TIMEOUT=v}]]);
