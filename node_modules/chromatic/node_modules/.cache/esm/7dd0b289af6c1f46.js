_af6‍.x([["addShimsToJSDOM",()=>addShimsToJSDOM]]);/* eslint-disable @typescript-eslint/no-empty-function, max-classes-per-file, no-param-reassign */
...
function mockSVG(window) {
  ...
  svgElements.forEach(e => {
    if (!window[e]) {
      ...
      const Value = _af6‍.u(eval(_af6‍.c(`(class ${e} extends window.HTMLElement {})`)));
