let meow,dedent,log,verifyOptions,sendDebugToLoggly,runTest,runPatchBuild;_af6‍.x([["parseArgv",()=>parseArgv],["run",()=>run]]);_af6‍.w("meow",[["default",["meow"],function(v){meow=v}]]);_af6‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_af6‍.w("./lib/log",[["default",["log"],function(v){log=v}]]);_af6‍.w("./lib/verify-option",[["verifyOptions",["verifyOptions"],function(v){verifyOptions=v}]]);_af6‍.w("./lib/sendDebugToLoggly",[["default",["sendDebugToLoggly"],function(v){sendDebugToLoggly=v}]]);_af6‍.w("./tester/index",[["runTest",["runTest"],function(v){runTest=v}]]);_af6‍.w("./tester/patchBuild",[["runPatchBuild",["runPatchBuild"],function(v){runPatchBuild=v}]]);
