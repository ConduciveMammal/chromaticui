let spawn,dedent,isClean,isUpToDate,getUpdateMessage,findMergeBase,checkout,checkoutPrevious,discardChanges,log,runTest;_af6‍.x([["runPatchBuild",()=>runPatchBuild]]);_af6‍.w("yarn-or-npm",[["spawn",["spawn"],function(v){spawn=v}]]);_af6‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_af6‍.w("../git/git",[["isClean",["isClean"],function(v){isClean=v}],["isUpToDate",["isUpToDate"],function(v){isUpToDate=v}],["getUpdateMessage",["getUpdateMessage"],function(v){getUpdateMessage=v}],["findMergeBase",["findMergeBase"],function(v){findMergeBase=v}],["checkout",["checkout"],function(v){checkout=v}],["checkoutPrevious",["checkoutPrevious"],function(v){checkoutPrevious=v}],["discardChanges",["discardChanges"],function(v){discardChanges=v}]]);_af6‍.w("../lib/log",[["default",["log"],function(v){log=v}]]);_af6‍.w("./index",[["runTest",["runTest"],function(v){runTest=v}]]);
