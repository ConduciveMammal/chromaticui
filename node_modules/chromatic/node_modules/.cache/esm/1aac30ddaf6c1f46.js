let fetch,pino,retry,serializers;_af6‍.x([["HTTPClientError",()=>HTTPClientError],["default",()=>HTTPClient]]);_af6‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);_af6‍.w("pino",[["default",["pino"],function(v){pino=v}]]);_af6‍.w("async-retry",[["default",["retry"],function(v){retry=v}]]);_af6‍.w("./serializers",[["default",["serializers"],function(v){serializers=v}]]);/* eslint-disable max-classes-per-file */
