let execSync,setupDebug,gql,dedent,EOL;_af6‍.x([["FETCH_N_INITIAL_BUILD_COMMITS",()=>FETCH_N_INITIAL_BUILD_COMMITS],["getCommit",()=>getCommit],["getBranch",()=>getBranch],["getBaselineCommits",()=>getBaselineCommits],["isUpToDate",()=>isUpToDate],["isClean",()=>isClean],["getUpdateMessage",()=>getUpdateMessage],["findMergeBase",()=>findMergeBase],["checkout",()=>checkout],["checkoutPrevious",()=>checkoutPrevious],["discardChanges",()=>discardChanges]]);_af6‍.w("child_process",[["execSync",["execSync"],function(v){execSync=v}]]);_af6‍.w("debug",[["default",["setupDebug"],function(v){setupDebug=v}]]);_af6‍.w("fake-tag",[["default",["gql"],function(v){gql=v}]]);_af6‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_af6‍.w("os",[["EOL",["EOL"],function(v){EOL=v}]]);
...
async function step(
  ...
  return step(client, limit * 2, {
    ...
    commitsWithoutBuilds: [...commitsWithoutBuilds, ...newCommitsWithoutBuilds],
       ...
       async function getBaselineCommits(client, { branch, ignoreLastBuildOnBranch = false } = {}) {
