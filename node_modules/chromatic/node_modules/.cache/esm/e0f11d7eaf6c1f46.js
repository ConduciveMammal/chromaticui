let fetch,pathExists,path,readline,denodeify,confirm,setupDebug,kill,parse,format,dirSync,gte,dedent,getStorybookInfo,startApp,checkResponse,openTunnel,checkPackageJson,addScriptToPackageJson,GraphQLClient,getBaselineCommits,packageVersion,CHROMATIC_INDEX_URL,CHROMATIC_TUNNEL_URL,CHROMATIC_POLL_INTERVAL,ENVIRONMENT_WHITELIST,STORYBOOK_CLI_FLAGS_BY_VERSION,uploadToS3,log,TesterBuildQuery,TesterCreateAppTokenMutation,TesterSkipBuildMutation,TesterCreateBuildMutation,pluralize,getCommitAndBranch,getStories;_af6‍.x([["debug",()=>debug],["runTest",()=>runTest]]);_af6‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);_af6‍.w("fs-extra",[["pathExists",["pathExists"],function(v){pathExists=v}]]);_af6‍.w("path",[["default",["path"],function(v){path=v}]]);_af6‍.w("readline",[["default",["readline"],function(v){readline=v}]]);_af6‍.w("denodeify",[["default",["denodeify"],function(v){denodeify=v}]]);_af6‍.w("node-ask",[["confirm",["confirm"],function(v){confirm=v}]]);_af6‍.w("debug",[["default",["setupDebug"],function(v){setupDebug=v}]]);_af6‍.w("tree-kill",[["default",["kill"],function(v){kill=v}]]);_af6‍.w("url",[["parse",["parse"],function(v){parse=v}],["format",["format"],function(v){format=v}]]);_af6‍.w("tmp",[["dirSync",["dirSync"],function(v){dirSync=v}]]);_af6‍.w("semver",[["gte",["gte"],function(v){gte=v}]]);_af6‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_af6‍.w("../storybook/get-info",[["default",["getStorybookInfo"],function(v){getStorybookInfo=v}]]);_af6‍.w("../storybook/start-app",[["default",["startApp"],function(v){startApp=v}],["checkResponse",["checkResponse"],function(v){checkResponse=v}]]);_af6‍.w("../lib/tunnel",[["default",["openTunnel"],function(v){openTunnel=v}]]);_af6‍.w("../lib/package-json",[["checkPackageJson",["checkPackageJson"],function(v){checkPackageJson=v}],["addScriptToPackageJson",["addScriptToPackageJson"],function(v){addScriptToPackageJson=v}]]);_af6‍.w("../io/GraphQLClient",[["default",["GraphQLClient"],function(v){GraphQLClient=v}]]);_af6‍.w("../git/git",[["getBaselineCommits",["getBaselineCommits"],function(v){getBaselineCommits=v}]]);_af6‍.w("../../package.json",[["version",["packageVersion"],function(v){packageVersion=v}]]);_af6‍.w("../constants",[["CHROMATIC_INDEX_URL",["CHROMATIC_INDEX_URL"],function(v){CHROMATIC_INDEX_URL=v}],["CHROMATIC_TUNNEL_URL",["CHROMATIC_TUNNEL_URL"],function(v){CHROMATIC_TUNNEL_URL=v}],["CHROMATIC_POLL_INTERVAL",["CHROMATIC_POLL_INTERVAL"],function(v){CHROMATIC_POLL_INTERVAL=v}],["ENVIRONMENT_WHITELIST",["ENVIRONMENT_WHITELIST"],function(v){ENVIRONMENT_WHITELIST=v}],["STORYBOOK_CLI_FLAGS_BY_VERSION",["STORYBOOK_CLI_FLAGS_BY_VERSION"],function(v){STORYBOOK_CLI_FLAGS_BY_VERSION=v}]]);_af6‍.w("../io/upload-to-s3",[["uploadToS3",["uploadToS3"],function(v){uploadToS3=v}]]);_af6‍.w("../lib/log",[["default",["log"],function(v){log=v}]]);_af6‍.w("../io/gql-queries",[["TesterBuildQuery",["TesterBuildQuery"],function(v){TesterBuildQuery=v}],["TesterCreateAppTokenMutation",["TesterCreateAppTokenMutation"],function(v){TesterCreateAppTokenMutation=v}],["TesterSkipBuildMutation",["TesterSkipBuildMutation"],function(v){TesterSkipBuildMutation=v}],["TesterCreateBuildMutation",["TesterCreateBuildMutation"],function(v){TesterCreateBuildMutation=v}]]);_af6‍.w("../lib/pluralize",[["pluralize",["pluralize"],function(v){pluralize=v}]]);_af6‍.w("../git/getCommitAndBranch",[["getCommitAndBranch",["getCommitAndBranch"],function(v){getCommitAndBranch=v}]]);_af6‍.w("../storybook/getStories",[["getStories",["getStories"],function(v){getStories=v}]]);
       ...
       const debug = setupDebug('chromatic-cli:tester');
