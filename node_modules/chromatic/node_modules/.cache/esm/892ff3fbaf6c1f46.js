let envCi,dedent,setupDebug,getCommit,getBranch,log;_af6‍.x([["debug",()=>debug],["getCommitAndBranch",()=>getCommitAndBranch]]);_af6‍.w("env-ci",[["default",["envCi"],function(v){envCi=v}]]);_af6‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_af6‍.w("debug",[["default",["setupDebug"],function(v){setupDebug=v}]]);_af6‍.w("./git",[["getCommit",["getCommit"],function(v){getCommit=v}],["getBranch",["getBranch"],function(v){getBranch=v}]]);_af6‍.w("../lib/log",[["default",["log"],function(v){log=v}]]);
