let JSDOM,VirtualConsole,ResourceLoader,dedent,extract,log,separator,addShimsToJSDOM;_af6‍.x([["default",()=>getRuntimeSpecs]]);_af6‍.w("jsdom",[["JSDOM",["JSDOM"],function(v){JSDOM=v}],["VirtualConsole",["VirtualConsole"],function(v){VirtualConsole=v}],["ResourceLoader",["ResourceLoader"],function(v){ResourceLoader=v}]]);_af6‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_af6‍.w("../storybook/extract",[["extract",["extract"],function(v){extract=v}]]);_af6‍.w("../lib/log",[["default",["log"],function(v){log=v}],["separator",["separator"],function(v){separator=v}]]);_af6‍.w("../lib/jsdom-shims",[["addShimsToJSDOM",["addShimsToJSDOM"],function(v){addShimsToJSDOM=v}]]);/* eslint-disable no-useless-catch, no-console, no-underscore-dangle */
               ...
               async function getRuntimeSpecs(
  url,
